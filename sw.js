...
const CACHE_VERSION = "c0f0714d6a";
...
const PRECACHE_URLS = [
  ...
  "/script.js?v=080d1b3604",
  "/shared/app/analytics-transport.js",
  "/shared/app/app.js?v=1362bea16d",
  ...
  "/shared/archive-record.js?v=3ce62111b2",
  "/shared/archive-search.js?v=59720d2d4e",
  "/shared/archive-similarity.js?v=0e81c0d1c6",
  "/site.webmanifest",
