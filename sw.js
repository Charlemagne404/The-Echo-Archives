...
const CACHE_VERSION = "04e3665262";
...
const PRECACHE_URLS = [
  ...
  "/icon-192.png",
  "/icon-512.png",
  "/info.css?v=888d382afe",
  "/offline.html",
  "/script.js?v=eb015a81ce",
  "/shared/app/app.js?v=4e9572025e",
  ...
  "/shared/archive-record.js?v=dedd423053",
  "/shared/archive-search.js?v=f9204f6b58",
  "/site.webmanifest",
  "/style.css?v=bbbdb2cafd"
];
