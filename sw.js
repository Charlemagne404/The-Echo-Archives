...
const CACHE_VERSION = "4d6fa4183f";
...
const PRECACHE_URLS = [
  ...
  "/icon-192.png",
  "/icon-512.png",
  "/info.css?v=805e1167d0",
  "/offline.html",
  "/public-heroes.css?v=daedd40bd0",
  "/script.js?v=9ba3d44201",
  "/shared/app/app.js?v=431256cf85",
  ...
  "/shared/archive-search.js?v=492045ed14",
  "/site.webmanifest",
  "/style.css?v=adc6d2cab6"
];
