...
export function renderListenerReviewMode(draft, context) {
  return [
    ...
    renderChipGroupField({
      ...
      options: context.tagFieldOptions.bestFor || REVIEW_CONTEXT_OPTIONS,
      ...
      allowCustom: false,
      inputLabel: "Filter listening contexts",
      placeholder: "Filter listening contexts",
    }),
    renderChipGroupField({
      ...
      options: context.tagFieldOptions.workedBest || REVIEW_STRENGTH_OPTIONS,
      activeField: context.activeTagField,
      menuOpen: context.tagPickerOpen,
      query: context.tagQuery,
      highlightIndex: context.tagHighlightIndex,
      allowCustom: false,
      inputLabel: "Filter standout elements",
      placeholder: "Filter standout elements",
    }),
    renderTextInputField({
