...
export function iconMarkup(name) {
  switch (name) {
    case "mode-show":
      return `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 19.25v-6.5M8.75 19.25h6.5M9.5 12.75h5M10.1 12.75 12 6.25l1.9 6.5M10.85 10.1h2.3" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"/><path class="icon-accent" d="M8.45 8.05a4.9 4.9 0 0 0 0 6.9M6 5.6a8.35 8.35 0 0 0 0 11.8M15.55 8.05a4.9 4.9 0 0 1 0 6.9M18 5.6a8.35 8.35 0 0 1 0 11.8" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"/><circle class="icon-accent-fill" cx="12" cy="4.25" r="1.35"/></svg>`;
    case "mode-correction":
      return `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.25 4.5h7.5l4 4v10.75a1.25 1.25 0 0 1-1.25 1.25h-10a1.25 1.25 0 0 1-1.25-1.25v-13A1.25 1.25 0 0 1 6.25 4.5Z M13.75 4.5v4h4" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"/><path d="m9.35 16.65.85-2.65 5.55-5.55a1.45 1.45 0 0 1 2.05 2.05l-5.55 5.55-2.65.85Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"/><path class="icon-accent" d="m15.05 9.15 2.05 2.05" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"/></svg>`;
    case "mode-review":
