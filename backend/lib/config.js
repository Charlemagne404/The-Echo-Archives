...
const config = {
  ...
  COMMUNITY_PROFILE_METADATA_RETENTION_DAYS: parseInteger(
    process.env.COMMUNITY_PROFILE_METADATA_RETENTION_DAYS,
    30,
  ),
  COMMUNITY_ORPHAN_PROFILE_RETENTION_DAYS: parseInteger(
    process.env.COMMUNITY_ORPHAN_PROFILE_RETENTION_DAYS,
    90,
  ),
  ...
  SUBMISSION_PERSONAL_DATA_RETENTION_DAYS: parseInteger(
    process.env.SUBMISSION_PERSONAL_DATA_RETENTION_DAYS,
    180,
  ),
  SUBMISSION_NETWORK_DATA_RETENTION_DAYS: parseInteger(
    process.env.SUBMISSION_NETWORK_DATA_RETENTION_DAYS,
    30,
  ),
  DATA_RETENTION_CLEANUP_INTERVAL_MS: parseInteger(
...
const POSITIVE_INTEGER_KEYS = [
  ...
  "COMMUNITY_PROFILE_METADATA_RETENTION_DAYS",
  "COMMUNITY_ORPHAN_PROFILE_RETENTION_DAYS",
  "COMMUNITY_SUMMARY_MAX_IDS",
  "COMMUNITY_TURNSTILE_TIMEOUT_MS",
  "SUBMISSION_RATE_LIMIT_WINDOW_MS",
  "SUBMISSION_RATE_LIMIT_MAX",
  "SUBMISSION_PERSONAL_DATA_RETENTION_DAYS",
  "SUBMISSION_NETWORK_DATA_RETENTION_DAYS",
...
function validateConfig(candidate = config) {
  ...
  if (candidate.SUBMISSION_NETWORK_DATA_RETENTION_DAYS > candidate.SUBMISSION_PERSONAL_DATA_RETENTION_DAYS) {
    errors.push("SUBMISSION_NETWORK_DATA_RETENTION_DAYS must not exceed SUBMISSION_PERSONAL_DATA_RETENTION_DAYS.");
  }

  if (candidate.COMMUNITY_PROFILE_METADATA_RETENTION_DAYS > candidate.COMMUNITY_ORPHAN_PROFILE_RETENTION_DAYS) {
    errors.push(
      "COMMUNITY_PROFILE_METADATA_RETENTION_DAYS must not exceed COMMUNITY_ORPHAN_PROFILE_RETENTION_DAYS.",
    );
  }
